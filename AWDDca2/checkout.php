                        ...
                        <div class="col-md-4 col-12">
                            ...
                            <ul class="list-group mb-3">
                                <li class="list-group-item d-flex justify-content-between lh-sm">
                                    <div>
                                        <h6 class="my-0"><?= $jersey->jersey_name ?></h6>
                                    </div>
                                    <span class="text-muted">$<?= $jersey->price ?></span>
                                </li>

                                <li class="list-group-item d-flex justify-content-between">
                                    <span>Total</span>
                                    <strong>$<?= $jersey->price ?></strong>
                                </li>
                            </ul>
                            <div class=" d-flex justify-content-center mt-5">
                                <button type="submit" href="<?= APP_URL ?>/index.php" class="btn btn-warning add-cart col-md-12 col-12">Place
                                    Order Now</button>
                            </div>
                        </div>
                    </form>

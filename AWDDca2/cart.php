                ...
                <div class="row mt-5 pb-5 d-flex justify-content-center align-items-center    ">
                    ...
                    <div class="col-md-3 col-3 ">
                        <div class=" ms-4 card-body text-center">
                            <p class="   card-text"><?= $jersey -> jersey_name ?></p>
                            <h6 class="  price" style="color: yellow;">$<?= $jersey -> price ?></h6>
                        </div>
                    ...
                    <div class="col-md-3 col-3 ">
                        <div class="card-body text-center ">
                            <button class="btn btn-outline-danger" href="<?= APP_URL ?>/shop.php">Remove</button>
                        </div>
    ...
    <div class="container-fluid">
        <div class="container">
            <div class=" d-flex justify-content-center">
                <form method="get">
                    <button class="btn btn-warning add-cart col-md-12 mt-5 " name="id" value="<?= $jersey->id ?>"
                        formaction="<?= APP_URL ?>/checkout.php">Add to
                        Cart</button>
                </form>
            </div>
        </div>
